                                        ...
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void aVoid) {
                                                ...
                                                prepareNotification(
                                                        ...
                                                        ""+name+" added new post",//message of the notification
                                                        ""+title+"\n"+description,
                                                        "PostNotification",
                                                        "POST"
                                                );
    ...
    private void sendPostNotification(JSONObject notificationJo) {
                ...
                })
        {
            ...
            public Map<String, String> getHeaders() throws AuthFailureError {
                ...
                headers.put("Authorization", "key=AAAAzUYnnOI:APA91bEeBlMjNd9EdUeSyKyRtWJJ4Ex6jqBkrdU6s46yf13quyDDa5wzQfRO-6RJTsy-c68kceB1cRQvWVFYUzIA0UQ49N8R9QS6lIR2xb3w6eoSuA8L118FUjcCzyFlqjCypOtm3Zef");// paste your fcm key here
                return headers;
            }
        };
