...
import com.canibal.firebaseapp.adapters.AdapterComments;
import com.canibal.firebaseapp.models.ModelComment;
...
public class PostDetailActivity extends AppCompatActivity {
    ...
    private void shareTextOnly(String pTitle, String pDescription) {
        ...
        startActivity(Intent.createChooser(sIntent, "Share Via")); //mensaje para mostrar en el diálogo de compartir
    ...
    private Uri saveImageToShare(Bitmap bitmap) {
        ...
        try {
            ...
            stream.flush();
            stream.close();
            uri = FileProvider.getUriForFile(this, "com.canibal.firebaseapp.fileprovider",
                    file);
